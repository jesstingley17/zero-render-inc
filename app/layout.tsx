  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Defer all analytics scripts to reduce TBT - load after page is interactive */}
        ...
        {/* Google Ads - Load only one gtag.js and configure both IDs - deferred to reduce blocking */}
      ...
      <body className={`${geist.className} antialiased`}>
        ...
        {children}
        {/* Defer analytics to reduce TBT - load after page is interactive */}
        <Analytics />
        <SpeedInsights />
      </body>
    </html>
